...
export interface IItem {
  ...
  damage?: string,  //die roll + modifier
  damageType?: DamageTypes,  //piercing, slashing, bludgeoning
  fixed?: boolean // fixed means object is not able to be picked up
}

const itemCatalog: IItem[] = [
  {
    name: 'short sword',
