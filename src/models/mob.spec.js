...
//     mob = new sutModel(mobType, room.roomId, 0);
...
//       // assert
//       expect(room.spawnTimer).not.toBeNull();
//     });
...
//       // assert
//       expect(mockGlobalIO.to(room.id).emit).toHaveBeenCalledWith('output', { message: `The ${mob.displayName} collapses.` });
//     });
...
//       socketUtil.socketInRoom.and.callFake(() => false);
...
//       // arrange
//       socketUtil.socketInRoom.and.callFake(() => true);
